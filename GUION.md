...
Cuando existe comparación Bad/Good, el bloque incluye tres puntos para la demo en vivo: **Qué está mal** (el defecto concreto en el código de la versión Bad), **Cómo reproducirlo** (los pasos que el presentador puede ejecutar en el momento para evidenciarlo) y **Solución** (qué cambia la versión Good y por qué eso lo resuelve).
