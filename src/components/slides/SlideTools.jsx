...
import { MonitorSmartphone, Lightbulb, ShieldCheck, TestTube2 } from 'lucide-react';
...
export default function SlideTools() {
  return (
    <Slide>
      <h2 className="text-4xl text-cyan-300 mb-2">¿Qué herramientas podemos usar?</h2>
      <p className="text-lg text-gray-400 mb-8 italic">Para evaluar la accesibilidad de nuestros productos.</p>
